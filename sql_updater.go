...
// Columns sets columns to be updated
func (this *SQLUpdater) Columns(cols ...string) *SQLUpdater {
	this.columns = cols
	return this
}

// With updates given row to table
func (this *SQLUpdater) With(row interface{}) (sql.Result, error) {
	if this.err != nil {
		return nil, this.err
	}
